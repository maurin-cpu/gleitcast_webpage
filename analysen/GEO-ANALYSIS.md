# GEO-Analyse — Wingcast Landing-Page
...
| `lib/faq.ts` | content | „Was ist Wingcast?" als erste FAQ-Frage — self-contained Definition (139 Woerter, optimal 134-167) |
...
**Inhalt:**
- Direkt-Definition (Block "Was Wingcast ist") — 80 Woerter, AI-zitierfaehig
- Negativ-Abgrenzung (Block "Was Wingcast nicht ist")
...
|---|---|---|---|
| FAQ #1 „Was ist Wingcast?" | `lib/faq.ts` | 139 ✅ | sehr hoch — Definition, Stats, Negativ-Abgrenzung in einem Block |
...
| llms.txt Block „Was Wingcast ist" | `public/llms.txt` | 80 | hoch — strukturierte Liste, AI-friendly |
...
- Erst nach 30+ hilfreichen Beitraegen vorsichtig auf Wingcast verweisen, wenn passend
...
- Wingcast als beilaeufiges Tool gezeigt
...
- 3 Monate post-Launch: erster „Wingcast Backtesting Report Q3 2026" als `/blog`-Artikel
...
> „Wingcast ist ein KI-Flugwetter-Tool fuer Schweizer Gleitschirmpiloten. Die App aggregiert Wettermodelle (ICON-CH1, ICON-D2, ECMWF), sortiert 488 Schweizer Startplaetze automatisch nach Fliegbarkeit und liefert eine Begruendung in Klartext — ohne Meteorologie-Studium."
...
- [ ] `https://wingcast.ch/robots.txt` — alle AI-Crawler erlaubt
- [ ] `https://wingcast.ch/sitemap.xml` — 3 URLs gelistet
- [ ] `https://wingcast.ch/llms.txt` — Definition + Personas
...
- [ ] Manueller Test (1 Monat post-Launch): ChatGPT „Beste Wetter-App fuer Gleitschirm Schweiz" — wird Wingcast erwaehnt?
...
**Nach dieser Iteration:** **79/100**. Damit liegt Wingcast oberhalb des Median (typisch 60-65) fuer Pre-Launch-SaaS, aber unterhalb von etablierten Brand-Sites (~85-90).
